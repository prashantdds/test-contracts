...
async function main(){
    ...
    Registration = await RegistrationContract.attach("0x2c9E1152585c7662b94a477df70EA5186A9CA8A6");
    ...
    await Registration.createSubnet(1,deployer.address, 1,true,1,true,[1,2,3],[],3,[],5);
    ...
    const id = await Subscription.subscribeNew(ethers.utils.parseEther("1"),0,"ddf","0x8198f5d8F8CfFE8f9C413d98a0A55aEB8ab9FbB7",122,[1,1,1]);
