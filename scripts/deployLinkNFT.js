...
async function main(){
    ...
    linknft = await upgrades.deployProxy(LinkNFTs, [appNFT.address], { initializer: 'initialize' });
    ...
    console.log("Please change the chainid to StackOS chainid in smart contract for deployment to mainnet");
}
